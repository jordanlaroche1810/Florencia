    ...
    <div class="body-inner">
            ...
            <div class="slide kenburns" data-bg-image="images/slider/notgeneric_bg3.jpg">
                ...
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        <!-- Captions -->
                        <h1 data-caption-animate="zoom-out">Florencia</h1>
                        <p>Wedding Designer</p>
                        <div><a href="#welcome" class="btn btn-primary scroll-to">Découvrir</a></div>
                        </span>
                        <!-- end: Captions -->
                    </div>
                </div>
        ...
        <footer id="footer" class="inverted">
            ...
            <div class="copyright-content">
                <div class="container">
                    <div class="copyright-text text-center">2024 Florencia - Wedding designer.</div>
                </div>
            </div>
        </footer>
        <!-- end: Footer -->
